...
export const config = convict({
  ...
  keycloakGrantType: {
    doc: 'The url for the Google Apps Script for writing to Google Sheet',
    default: 'http://localhost:3000',
    env: 'KEYCLOAK_GRANT_TYPE'
  },
  keycloakSubjectTokenType: {
    doc: 'The url for the Google Apps Script for writing to Google Sheet',
    default: 'http://localhost:3000',
    env: 'KEYCLOAK_SUBJECT_TOKEN_TYPE'
  },
  keycloakSubjectIssuer: {
    doc: 'The url for the Google Apps Script for writing to Google Sheet',
    default: 'http://localhost:3000',
    env: 'KEYCLOAK_SUBJECT_ISSUER'
  },
  keycloakClientId: {
    doc: 'The url for the Google Apps Script for writing to Google Sheet',
    default: 'http://localhost:3000',
